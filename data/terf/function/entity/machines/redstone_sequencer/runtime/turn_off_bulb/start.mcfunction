...
execute if score target_bulb terf_states matches 0 positioned ^ ^ ^1 run function terf:entity/machines/redstone_sequencer/runtime/turn_off_bulb/raycast_all
execute if score target_bulb terf_states matches 1.. positioned ^ ^ ^1 run function terf:entity/machines/redstone_sequencer/runtime/turn_off_bulb/raycast
