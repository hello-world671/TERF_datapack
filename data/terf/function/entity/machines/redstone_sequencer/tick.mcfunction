...
#if it has instructions
execute unless data entity @s data.terf.instruction_stream[0] run return fail
...
function terf:entity/machines/redstone_sequencer/runtime/iterate
